    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(choices=[('all', 'Вся Украина'), ('karkov', 'Харьков'), ('kiev', 'Киев'), ('dnepr', 'Днепр'), ('sumy', 'Суммы'), ('ternopol', 'Тернополь'), ('vinica', 'Винница'), ('lvov', 'Львов')], default='all', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefix', models.CharField(blank=True, default='+38', max_length=4, null=True)),
